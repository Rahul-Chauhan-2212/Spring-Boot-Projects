package com.springboot.http.intgeration;
...
public class SpringBootHttpIntegrationApplication {
	@Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringBootHttpIntegrationApplication.class, args);
	}
